...
load("./MCMC_model/outputs/ans.munic1.20000.08.RData")
chain1<-ans.munic
chain1<-mcmc(chain1,start=1000,end=4000)
load("./MCMC_model/outputs/ans.munic2.20000.08.RData")
chain2<-ans.munic
chain2<-mcmc(chain2,start=1000,end=4000)
load("./MCMC_model/outputs/ans.munic3.20000.08.RData")
chain3<-ans.munic
chain3<-mcmc(chain3,start=1000,end=4000)
...
save(TranMatArray.234x234,file="./ModelProjections/data/TranMatArray.234x234.RData")
