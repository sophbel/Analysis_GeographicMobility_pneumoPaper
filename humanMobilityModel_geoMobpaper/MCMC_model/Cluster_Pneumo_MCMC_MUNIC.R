...
source("/lustre/scratch118/infgen/team284/sb62/Migration/SouthAfrica/mobility_model/SA_Migration_130422/MCMC_model/LikelihoodFunctions/LikFunc.mcmc.Munic.R")}else{
sourceCpp("/Users/sb62/Documents/Migration/SA_Migration_110422/MCMC_model/MatrixMultiplication.cpp")
source("/Users/sb62/Documents/Migration/SA_Migration_110422/MCMC_model/LikelihoodFunctions/LikFunc.mcmc.Munic.R")}
...
if(cluster==TRUE){
setwd("/lustre/scratch118/infgen/team284/sb62/Migration/SouthAfrica/mobility_model/SA_Migration_130422/MCMC_model/RunModel/outputs/munic/")
save(ans.munic,file=paste0("ans.munic",chain,".",iters,".08",".RData"))}
# }
