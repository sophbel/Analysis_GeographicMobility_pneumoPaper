...
truthvec<-c(TRUE,FALSE)
for(truth in truthvec){
  # categorical=TRUE
  categorical=truth
...
if(categorical==TRUE){
  ...
  save(matplot_specificRange.noSub,file="./RelativeRisk/files/matplot_specificRange.noSub_cat_mulTrees_260923_disease_samp.RData")
  
  
}else{
  # save(matplot_continuous,file="./RelativeRisk/files/mat_sub_genomic_cont_multiTrees_disease.RData")
  save(matplot_continuous,file="./RelativeRisk/files/mat_sub_genomic_cont_multiTrees_disease_samp.RData")
