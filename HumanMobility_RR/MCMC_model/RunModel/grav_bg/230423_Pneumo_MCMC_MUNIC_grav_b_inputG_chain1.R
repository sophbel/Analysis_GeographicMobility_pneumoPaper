...
source("./MCMC_model/LikelihoodFunctions/LikFunc.mcmc.Munic_grav_b_inputG.R")
...
#### running gravity model estimating beta but inputting gamma and other parameters.
fit.par_grav_G<-readRDS(file="./MCMC_model/outputs/gravity_model/grav_g/fit.par_grav_G.RData")
### input pre-estimated gamma
extTranMatDat.tmp$pars$gamma<-fit.par_grav_G[1]
### input pre-estimated infection probabilities
infec_probs<-fit.par_grav_G[2:9]
...
save(ans.munic,file=paste0("./MCMC_model/outputs/gravity_model/grav_bg/ans.munic",chain,".",iters,".08_gravity_adj_b_inputG",".RData"))
