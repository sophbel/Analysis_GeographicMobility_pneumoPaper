...
source("./MCMC_model/LikelihoodFunctions/LikFunc.mcmc.Munic_grav_abg.R")
...
save(ans.munic,file=paste0("./MCMC_model/outputs/gravity_model/ans.munic",chain,".",iters,".08_gravity_adj_abg",".RData"))
